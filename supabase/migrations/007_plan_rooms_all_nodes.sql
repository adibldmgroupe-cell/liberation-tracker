...
-- ═══════════════════════════════════════════════════════════════════════════
-- Cette migration doit être exécutée APRÈS la migration 006
-- Elle garantit que chaque nœud du schéma est directement opérationnel
-- sans qu'un opérateur ait à "essuyer les plâtres"
-- ═══════════════════════════════════════════════════════════════════════════

-- ─────────────────────────────────────────────────────────────────────────────
-- ÉTAPE 1 : S'assurer que tous les ateliers FAB existent avec le bon nom
-- (complément de migration 006 pour les N° non encore créés)
-- ─────────────────────────────────────────────────────────────────────────────
...
-- ─────────────────────────────────────────────────────────────────────────────
-- ÉTAPE 2 : Peupler plan_rooms pour tous les nœuds FAB (type 'fab')
-- code SVG → atelier_id via nom_atelier
-- ─────────────────────────────────────────────────────────────────────────────

INSERT INTO plan_rooms (code, atelier_id, equipement_id)
SELECT 'p464', id, NULL FROM ateliers WHERE nom_atelier = 'Salle pesée -02'
ON CONFLICT (code) DO UPDATE SET atelier_id = EXCLUDED.atelier_id, equipement_id = NULL;

INSERT INTO plan_rooms (code, atelier_id, equipement_id)
SELECT 'p471', id, NULL FROM ateliers WHERE nom_atelier = 'Salle pesée -03'
ON CONFLICT (code) DO UPDATE SET atelier_id = EXCLUDED.atelier_id, equipement_id = NULL;

INSERT INTO plan_rooms (code, atelier_id, equipement_id)
SELECT 'n140', id, NULL FROM ateliers WHERE nom_atelier = 'Salle de granulation et séchage 01'
ON CONFLICT (code) DO UPDATE SET atelier_id = EXCLUDED.atelier_id, equipement_id = NULL;

INSERT INTO plan_rooms (code, atelier_id, equipement_id)
SELECT 'n425', id, NULL FROM ateliers WHERE nom_atelier = 'Salle de granulation et séchage 02'
ON CONFLICT (code) DO UPDATE SET atelier_id = EXCLUDED.atelier_id, equipement_id = NULL;

INSERT INTO plan_rooms (code, atelier_id, equipement_id)
SELECT 'n138', id, NULL FROM ateliers WHERE nom_atelier LIKE '%mélange 01%'
ON CONFLICT (code) DO UPDATE SET atelier_id = EXCLUDED.atelier_id, equipement_id = NULL;

INSERT INTO plan_rooms (code, atelier_id, equipement_id)
SELECT 'n137', id, NULL FROM ateliers WHERE nom_atelier LIKE '%mélange 02%'
ON CONFLICT (code) DO UPDATE SET atelier_id = EXCLUDED.atelier_id, equipement_id = NULL;

INSERT INTO plan_rooms (code, atelier_id, equipement_id)
SELECT 'n448', id, NULL FROM ateliers WHERE nom_atelier = 'Salle de mélange 03'
ON CONFLICT (code) DO UPDATE SET atelier_id = EXCLUDED.atelier_id, equipement_id = NULL;

INSERT INTO plan_rooms (code, atelier_id, equipement_id)
SELECT 'n131', id, NULL FROM ateliers WHERE nom_atelier = 'Salle de compression 01'
ON CONFLICT (code) DO UPDATE SET atelier_id = EXCLUDED.atelier_id, equipement_id = NULL;

INSERT INTO plan_rooms (code, atelier_id, equipement_id)
SELECT 'n128', id, NULL FROM ateliers WHERE nom_atelier = 'Salle de compression 02'
ON CONFLICT (code) DO UPDATE SET atelier_id = EXCLUDED.atelier_id, equipement_id = NULL;

INSERT INTO plan_rooms (code, atelier_id, equipement_id)
SELECT 'n134', id, NULL FROM ateliers WHERE nom_atelier = 'Salle de compression 03'
ON CONFLICT (code) DO UPDATE SET atelier_id = EXCLUDED.atelier_id, equipement_id = NULL;

INSERT INTO plan_rooms (code, atelier_id, equipement_id)
SELECT 'n445', id, NULL FROM ateliers WHERE nom_atelier = 'Salle de compression 04'
ON CONFLICT (code) DO UPDATE SET atelier_id = EXCLUDED.atelier_id, equipement_id = NULL;

INSERT INTO plan_rooms (code, atelier_id, equipement_id)
SELECT 'n143', id, NULL FROM ateliers WHERE nom_atelier = 'Salle de pelliculage 01'
ON CONFLICT (code) DO UPDATE SET atelier_id = EXCLUDED.atelier_id, equipement_id = NULL;

INSERT INTO plan_rooms (code, atelier_id, equipement_id)
SELECT 'n136', id, NULL FROM ateliers WHERE nom_atelier = 'Salle de pelliculage 03'
ON CONFLICT (code) DO UPDATE SET atelier_id = EXCLUDED.atelier_id, equipement_id = NULL;

INSERT INTO plan_rooms (code, atelier_id, equipement_id)
SELECT 'n429', id, NULL FROM ateliers WHERE nom_atelier = 'Salle de pelliculage 02'
ON CONFLICT (code) DO UPDATE SET atelier_id = EXCLUDED.atelier_id, equipement_id = NULL;

INSERT INTO plan_rooms (code, atelier_id, equipement_id)
SELECT 'n436', id, NULL FROM ateliers WHERE nom_atelier = 'Salle de remplissage gélules 02'
ON CONFLICT (code) DO UPDATE SET atelier_id = EXCLUDED.atelier_id, equipement_id = NULL;

INSERT INTO plan_rooms (code, atelier_id, equipement_id)
SELECT 'n442', id, NULL FROM ateliers WHERE nom_atelier = 'Salle Formulation'
ON CONFLICT (code) DO UPDATE SET atelier_id = EXCLUDED.atelier_id, equipement_id = NULL;

INSERT INTO plan_rooms (code, atelier_id, equipement_id)
SELECT 'n200', id, NULL FROM ateliers WHERE nom_atelier = 'Salle de mélange homogénéisateur'
ON CONFLICT (code) DO UPDATE SET atelier_id = EXCLUDED.atelier_id, equipement_id = NULL;

INSERT INTO plan_rooms (code, atelier_id, equipement_id)
SELECT 'n206', id, NULL FROM ateliers WHERE nom_atelier = 'Salle de remplissage des tubes'
ON CONFLICT (code) DO UPDATE SET atelier_id = EXCLUDED.atelier_id, equipement_id = NULL;

-- ─────────────────────────────────────────────────────────────────────────────
-- ÉTAPE 3 : Peupler plan_rooms pour les nœuds CONDITIONNEMENT (type 'cond')
-- code SVG → equipement_id via room_code dans equipements_conditionnement
-- ─────────────────────────────────────────────────────────────────────────────

-- Si room_code n'existe pas encore dans equipements_conditionnement,
-- on l'identifie par nom_equipement (équipements créés lors des imports)
INSERT INTO plan_rooms (code, atelier_id, equipement_id)
SELECT 'c149', NULL, id FROM equipements_conditionnement WHERE room_code = '149' OR nom_equipement ILIKE '%marchesini mb421%' LIMIT 1
ON CONFLICT (code) DO UPDATE SET equipement_id = EXCLUDED.equipement_id, atelier_id = NULL;

INSERT INTO plan_rooms (code, atelier_id, equipement_id)
SELECT 'c148', NULL, id FROM equipements_conditionnement WHERE room_code = '148' OR nom_equipement ILIKE '%ima tr100%' LIMIT 1
ON CONFLICT (code) DO UPDATE SET equipement_id = EXCLUDED.equipement_id, atelier_id = NULL;

INSERT INTO plan_rooms (code, atelier_id, equipement_id)
SELECT 'c147', NULL, id FROM equipements_conditionnement WHERE room_code = '147' OR nom_equipement ILIKE '%integra 300%' LIMIT 1
ON CONFLICT (code) DO UPDATE SET equipement_id = EXCLUDED.equipement_id, atelier_id = NULL;

INSERT INTO plan_rooms (code, atelier_id, equipement_id)
SELECT 'c146', NULL, id FROM equipements_conditionnement WHERE room_code = '146' OR nom_equipement ILIKE '%ima pg super 1%' LIMIT 1
ON CONFLICT (code) DO UPDATE SET equipement_id = EXCLUDED.equipement_id, atelier_id = NULL;

INSERT INTO plan_rooms (code, atelier_id, equipement_id)
SELECT 'c220', NULL, id FROM equipements_conditionnement WHERE room_code = '220' OR nom_equipement ILIKE '%marchesini r,p%' OR nom_equipement ILIKE '%marchesini rp%' LIMIT 1
ON CONFLICT (code) DO UPDATE SET equipement_id = EXCLUDED.equipement_id, atelier_id = NULL;

INSERT INTO plan_rooms (code, atelier_id, equipement_id)
SELECT 'c222', NULL, id FROM equipements_conditionnement WHERE room_code = '222' OR nom_equipement ILIKE '%integra 520%' LIMIT 1
ON CONFLICT (code) DO UPDATE SET equipement_id = EXCLUDED.equipement_id, atelier_id = NULL;

INSERT INTO plan_rooms (code, atelier_id, equipement_id)
SELECT 'c223', NULL, id FROM equipements_conditionnement WHERE room_code = '223' OR nom_equipement ILIKE '%ima pg super 2%' LIMIT 1
ON CONFLICT (code) DO UPDATE SET equipement_id = EXCLUDED.equipement_id, atelier_id = NULL;

INSERT INTO plan_rooms (code, atelier_id, equipement_id)
SELECT 'c153', NULL, id FROM equipements_conditionnement WHERE room_code = '153' OR nom_equipement ILIKE '%cond%sec%' LIMIT 1
ON CONFLICT (code) DO UPDATE SET equipement_id = EXCLUDED.equipement_id, atelier_id = NULL;

INSERT INTO plan_rooms (code, atelier_id, equipement_id)
SELECT 'c154', NULL, id FROM equipements_conditionnement WHERE room_code = '154' OR nom_equipement ILIKE '%cond%ext%' LIMIT 1
ON CONFLICT (code) DO UPDATE SET equipement_id = EXCLUDED.equipement_id, atelier_id = NULL;

INSERT INTO plan_rooms (code, atelier_id, equipement_id)
SELECT 'i521', NULL, id FROM equipements_conditionnement WHERE room_code = '521' OR nom_equipement ILIKE '%inject%' OR nom_equipement ILIKE '%réception%' LIMIT 1
ON CONFLICT (code) DO UPDATE SET equipement_id = EXCLUDED.equipement_id, atelier_id = NULL;

-- ─────────────────────────────────────────────────────────────────────────────
-- VÉRIFICATION : liste complète plan_rooms après migration
-- ─────────────────────────────────────────────────────────────────────────────

SELECT
  pr.code,
  CASE WHEN pr.atelier_id IS NOT NULL THEN 'FAB' ELSE 'COND' END AS type_node,
  COALESCE(a.nom_atelier, ec.nom_equipement) AS designation,
