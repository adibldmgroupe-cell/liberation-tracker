...
nomenclature de fabrication/conditionnement). ⚠️ Les MàJ (`isMajDoc`) ET la clôture SAP n'ont **PAS d'AR** :
parcours direct Émission → Vérif AQ → Approbation DT (3 clics, pas d'accusé de réception).
