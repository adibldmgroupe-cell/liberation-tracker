...
.ll-num{font-family:'SF Mono',monospace;font-weight:500;font-size:16px;color:#2563eb;margin-left:4px}
.form{margin-top:8px}
...
.input{width:100%;padding:8px 10px;border:1px solid #ddd;font-size:13px;outline:none;box-sizing:border-box;font-family:inherit}.input:focus{border-color:#2563eb}
...
.auto-code{font-family:'SF Mono',monospace;font-size:12px;font-weight:500;color:#2563eb;min-width:90px}
...
.count-val{font-size:24px;font-weight:500;font-family:'SF Mono',monospace;color:#2563eb;margin-right:6px}
...
.btn-confirm{flex:1;padding:10px;background:#2563eb;color:#fff;border:none;font-size:13px;font-weight:500;cursor:pointer;border-radius:2px}.btn-confirm:hover{background:#1d4ed8}.btn-confirm:disabled{opacity:.5}
...
.btn-see{margin-top:14px;padding:8px 20px;background:#2563eb;color:#fff;border:none;font-size:13px;cursor:pointer;border-radius:2px}.btn-see:hover{background:#1d4ed8}
