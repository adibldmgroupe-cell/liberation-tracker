<template>
  <span class="nicon" v-html="svg" aria-hidden="true"></span>
</template>
<script>
import { computed } from 'vue'

// Icônes au trait (style Lucide), 24x24, stroke=currentColor → héritent
// la couleur du thème (jour/nuit/atelier) et de l'état actif/hover.
var P = {
  ...
  'calendar-stats':'<rect width="18" height="18" x="3" y="4" rx="2"/><path d="M16 2v4"/><path d="M8 2v4"/><path d="M3 10h18"/><path d="M8 16v-2"/><path d="M12 16v-4"/><path d="M16 16v-3"/>',
  ...
  'flask':'<path d="M14 2v6a2 2 0 0 0 .245.96l5.51 10.04A2 2 0 0 1 18 22H6a2 2 0 0 1-1.755-2.96l5.51-10.04A2 2 0 0 0 10 8V2"/><path d="M6.453 15h11.094"/><path d="M8.5 2h7"/>',
...
export default {
  ...
  setup(props) {
    var svg = computed(function() {
      var inner = P[props.name] || ''
      var s = '' + props.size
...
<style scoped>
.nicon { display: inline-flex; align-items: center; justify-content: center; flex-shrink: 0; }
</style>
